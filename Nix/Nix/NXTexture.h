...
public:
    ...
    Ntr<NXTexture2D> CreateByData(const std::string& debugName, DXGI_FORMAT fmt, uint32_t width, uint32_t height, void* data, uint32_t byteSize, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE);
