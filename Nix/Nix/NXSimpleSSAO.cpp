...
//{
//	m_pTexSSAO = NXResourceManager::GetInstance()->GetTextureManager()->CreateRenderTexture("Simple SSAO", DXGI_FORMAT_R32G32B32A32_FLOAT, lround(rtSize.x), lround(rtSize.y), 1, 1, D3D11_BIND_SHADER_RESOURCE | D3D11_BIND_UNORDERED_ACCESS);
//	m_pTexSSAO->AddSRV();
//	m_pTexSSAO->AddUAV();
//
//	m_rtSize = rtSize;
