...
public:
	...
	ID3D11ShaderResourceView*		GetSRVPosition()		{ return m_pSRVPosition.Get(); }
...
private:
	...
	ComPtr<ID3D11ShaderResourceView>	m_pSRVPosition;
	ComPtr<ID3D11RenderTargetView>		m_pRTVPosition;
