...
public:
    ...
    Ntr<NXTexture2D> CreateUAVTexture(const std::string& name, DXGI_FORMAT fmt, UINT width, UINT height, UINT mipLevels = 1, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE, bool bAutoMakeViews = true);
