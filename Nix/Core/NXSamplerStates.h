...
private:
	...
	static ComPtr<ID3D11SamplerState> s_Point[ADDRESS_TYPE_COUNT][ADDRESS_TYPE_COUNT][ADDRESS_TYPE_COUNT];
	static ComPtr<ID3D11SamplerState> s_Linear[ADDRESS_TYPE_COUNT][ADDRESS_TYPE_COUNT][ADDRESS_TYPE_COUNT];
	static ComPtr<ID3D11SamplerState> s_Aniso[ADDRESS_TYPE_COUNT][ADDRESS_TYPE_COUNT][ADDRESS_TYPE_COUNT];
};
