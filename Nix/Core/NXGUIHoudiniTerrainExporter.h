...
struct NixTerrainDdsInfo
{
	...
	std::filesystem::path albedoMapPath;	// albedo.dds路径
...
private:
	...
	// 转换单个EXR到DDS (albedomap)
	void ConvertExrToAlbedoMapDDS(const HoudiniExrFileInfo& exrInfo, const std::filesystem::path& outPath);
...
private:
	...
	bool m_bBakeAlbedoMapSubTiles = true;	// 烘焙AlbedoMap子区域
