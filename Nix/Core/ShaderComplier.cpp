...
HRESULT NXShaderComplier::CompileVSByCode(const std::string& shaderCode, const std::string& mainFuncEntryPoint, ID3DBlob** pVSBlob, std::string& oErrorMessage, bool clearDefineMacros)
{
	HRESULT hr = S_OK;
...
HRESULT NXShaderComplier::CompilePSByCode(const std::string& shaderCode, const std::string& mainFuncEntryPoint, ID3DBlob** pPSBlob, std::string& oErrorMessage, bool clearDefineMacros)
{
	HRESULT hr = S_OK;
