...
D3D12_INPUT_LAYOUT_DESC	NXGlobalInputLayout::layoutPNTT_GPUInstancing;
...
void NXGlobalInputLayout::Init()
{
	...
	static D3D12_INPUT_ELEMENT_DESC layoutDescPNTT_GPUInstancing[] =
	{
		{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
		{ "NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 12, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
		{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, 24, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
		...
		{ "GPUINSWORLD", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 44, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 },
		{ "GPUINSWORLD", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 60, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 },
		{ "GPUINSWORLD", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 76, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 },
		{ "GPUINSWORLD", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 92, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 },
	};
	layoutPNTT_GPUInstancing = { layoutDescPNTT_GPUInstancing, _countof(layoutDescPNTT_GPUInstancing) };
