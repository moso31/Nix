...
template<
    ...
    // Repeat the pattern for RT2 to RT7
    // RT2 settings
...
public:
    static D3D12_BLEND_DESC Create()
    {
        ...
        desc.RenderTarget[0] = { RT0BlendEnable, RT0SrcBlend, RT0DestBlend, RT0BlendOp, RT0SrcBlendAlpha, RT0DestBlendAlpha, RT0BlendOpAlpha, RT0RenderTargetWriteMask };
        desc.RenderTarget[1] = { RT1BlendEnable, RT1SrcBlend, RT1DestBlend, RT1BlendOp, RT1SrcBlendAlpha, RT1DestBlendAlpha, RT1BlendOpAlpha, RT1RenderTargetWriteMask };
        desc.RenderTarget[2] = { RT2BlendEnable, RT2SrcBlend, RT2DestBlend, RT2BlendOp, RT2SrcBlendAlpha, RT2DestBlendAlpha, RT2BlendOpAlpha, RT2RenderTargetWriteMask };
        desc.RenderTarget[3] = { RT3BlendEnable, RT3SrcBlend, RT3DestBlend, RT3BlendOp, RT3SrcBlendAlpha, RT3DestBlendAlpha, RT3BlendOpAlpha, RT3RenderTargetWriteMask };
        desc.RenderTarget[4] = { RT4BlendEnable, RT4SrcBlend, RT4DestBlend, RT4BlendOp, RT4SrcBlendAlpha, RT4DestBlendAlpha, RT4BlendOpAlpha, RT4RenderTargetWriteMask };
        desc.RenderTarget[5] = { RT5BlendEnable, RT5SrcBlend, RT5DestBlend, RT5BlendOp, RT5SrcBlendAlpha, RT5DestBlendAlpha, RT5BlendOpAlpha, RT5RenderTargetWriteMask };
        desc.RenderTarget[6] = { RT6BlendEnable, RT6SrcBlend, RT6DestBlend, RT6BlendOp, RT6SrcBlendAlpha, RT6DestBlendAlpha, RT6BlendOpAlpha, RT6RenderTargetWriteMask };
        desc.RenderTarget[7] = { RT7BlendEnable, RT7SrcBlend, RT7DestBlend, RT7BlendOp, RT7SrcBlendAlpha, RT7DestBlendAlpha, RT7BlendOpAlpha, RT7RenderTargetWriteMask };
